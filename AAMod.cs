    ...
    class AAMod : Mod
    {
        ...
        public override void Load()
        {
            ...
            if (!Main.dedServ)
            {
                ...
                Filters.Scene["AAMod:MireSky"] = new Filter(new ScreenShaderData("FilterMiniTower").UseColor(0f, 0.20f, 1f).UseOpacity(0.4f), EffectPriority.VeryHigh);
                SkyManager.Instance["AAMod: MireSky"] = new MireSky();
                MireSky.PlanetTexture = GetTexture("Backgrounds/Mire/MireMoon");
                Filters.Scene["AAMod:VoidSky"] = new Filter(new ScreenShaderData("FilterMiniTower").UseColor(0.15f, 0.1f, 0.1f).UseOpacity(0.2f), EffectPriority.VeryHigh);
                SkyManager.Instance["AAMod:VoidSky"] = new VoidSky();
                VoidSky.PlanetTexture = GetTexture("Backgrounds/Void/VoidBH");
                Filters.Scene["AAMod:InfernoSky"] = new Filter(new ScreenShaderData("FilterMiniTower").UseColor(1f, 0.20f, 0f).UseOpacity(0.4f), EffectPriority.VeryHigh);
