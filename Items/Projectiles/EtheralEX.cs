...
namespace AAMod.Items.Projectiles
{
    public class Etheral : ModProjectile
    {
        ...
        public override void SetStaticDefaults()
        {
            ...
            DisplayName.SetDefault("Etheral EX");
		}
			...
			if (flag10 && Main.myPlayer == projectile.owner)
			{
				...
				if (flag12)
				{
					if (projectile.ai[0] == 1f)
					{
						...
						for (int l = 0; l < 7; l++)
						{
							Projectile.NewProjectile(center3.X, center3.Y, vector12.X, vector12.Y, mod.ProjectileType("EtheralBeam"), num29, projectile.knockBack, projectile.owner, (float)l, (float)projectile.whoAmI);
						}
						projectile.netUpdate = true;
					}
				}
        ...
        {
            return new Color(0, Main.DiscoG, 255, 200);
        }
    }
}