    ...
    public class DecayScythe : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if (projectile.rotation > MathHelper.TwoPi)
            {
                ...
                Projectile.NewProjectile(projectile.Center.X + (projectile.velocity.X * projectile.ai[0]), projectile.Center.Y + projectile.velocity.Y * projectile.ai[0], projectile.velocity.X * 1.4f, projectile.velocity.Y * 1.4f, mod.ProjectileType("DecayScytheProj"), (int)((double)projectile.damage * 0.85f), projectile.knockBack * 0.85f, projectile.owner, 0f, 0f);
            }
