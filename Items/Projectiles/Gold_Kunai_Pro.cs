...
{
    public class Gold_Kunai_Pro : ModProjectile
	{
		...
		public override void Kill(int timeLeft)
		{
			...
			{
				Item.NewItem((int)projectile.position.X, (int)projectile.position.Y, projectile.width, projectile.height, mod.ItemType("Gold_Kunai"));
			};
		}
