...
namespace AAMod.Items.Summoning
{
	...
	public class ChinStaff : ModItem
	{
		...
		{
            DisplayName.SetDefault("Magic Chinchilla Stick");
		...
		public override void SetDefaults()
		{
			...
			item.shoot = mod.ProjectileType("ChinchillaMinion");
			item.shootSpeed = 7f;
			item.buffType = mod.BuffType("ChinchillaMinionBuff");	//The buff added to player after used the item
            item.buffTime = 18000;
		}
