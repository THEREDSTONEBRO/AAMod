...
namespace AAMod.Items.Magic       ///We need this to basically indicate the folder where it is to be read from, so you the texture will load correctly
{
    public class LuminiteStaff : ModItem
    {
        ...
        public override void SetDefaults()
        {
            ...
            item.value = Item.buyPrice(1, 1, 0, 0); // How much the item is worth, in copper coins, when you sell it to a merchant. It costs 1/5th of this to buy it back from them. An easy way to remember the value is platinum, gold, silver, copper or PPGGSSCC (so this item price is 10gold)
            ...
            item.shoot = mod.ProjectileType("LuminiteStaffP");   //This defines what type of projectile this weapon will shot
		...
		public override void AddRecipes()  //How to craft this sword
			{
				...
				recipe.AddIngredient(3459, 8);//you need 1 DirtBlock
				recipe.AddTile(412);   //at work bench
