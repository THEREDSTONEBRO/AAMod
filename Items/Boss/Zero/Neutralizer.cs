...
namespace AAMod.Items.Boss.Zero
{
    class Neutralizer : ModItem
    {
        ...
        public override void SetDefaults()
        {
            ...
            item.useTime = 12;
            item.damage = 200;
            item.shoot = mod.ProjectileType<NeutralizerProj>();

            Tooltip.SetDefault("Shoots a piercing laser than gets stronger as it bouces on walls");
        }
    ...
    class NeutralizerProj : ModProjectile
    {
        public override void SetDefaults()
        {
            projectile.width = 4;
