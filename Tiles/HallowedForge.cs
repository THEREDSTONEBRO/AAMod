...
namespace AAMod.Tiles
{
    public class HallowedForge : ModTile
    {
        ...
        public override void PostDraw(int i, int j, Microsoft.Xna.Framework.Graphics.SpriteBatch spriteBatch)
        {
            ...
            Main.spriteBatch.Draw(mod.GetTexture("Tiles/HallowedForge_Glow"), new Vector2(i * 16 - (int)Main.screenPosition.X, j * 16 - (int)Main.screenPosition.Y) + zero, new Rectangle(tile.frameX, tile.frameY, 16, height), Color.White, 0f, Vector2.Zero, 1f, SpriteEffects.None, 0f);
        }
