...
namespace AAMod.Tiles
{
	public class VoidUnit : ModTile
	{
		public override void SetDefaults()
		{
			...
			AddMapEntry(new Color(75, 50, 50));
			dustType = 1;
		...
		public override bool PreDraw(int i, int j, SpriteBatch spriteBatch)
		{
			...
			Main.spriteBatch.Draw(mod.GetTexture("Tiles/VoidUnit_Glow"), new Vector2(i * 16 - (int)Main.screenPosition.X, j * 16 - (int)Main.screenPosition.Y) + zero, new Rectangle(tile.frameX, tile.frameY + animate, 16, height), Color.White, 0f, Vector2.Zero, 1f, SpriteEffects.None, 0f);
			return false;
		}
