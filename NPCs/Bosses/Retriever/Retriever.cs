        ...
        {
            {
                ...
                spriteBatch.Draw(mod.GetTexture("NPCs/Bosses/Retriever/Retriever_Glow"), new Vector2(npc.Center.X - Main.screenPosition.X, npc.Center.Y - Main.screenPosition.Y),
