        ...
        {
            {
                ...
                spriteBatch.Draw(mod.GetTexture("AAMod/NPCs/Bosses/Zero/Retriever_Glow"), new Vector2(npc.Center.X - Main.screenPosition.X, npc.Center.Y - Main.screenPosition.Y),
