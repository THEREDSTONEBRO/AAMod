...
{
    [AutoloadBossHead]
    public class GripOfChaosRed : ModNPC
    {
        ...
        public override void HitEffect(int hitDirection, double damage)
        {
            ...
            {
                Gore.NewGore(npc.position, npc.velocity, mod.GetGoreSlot("Gore/GripOfChaosRedGore1"), 1f);
                Gore.NewGore(npc.position, npc.velocity, mod.GetGoreSlot("Gore/GripOfChaosRedGore2"), 1f);
                Gore.NewGore(npc.position, npc.velocity, mod.GetGoreSlot("Gore/GripOfChaosRedGore3"), 1f);
                Gore.NewGore(npc.position, npc.velocity, mod.GetGoreSlot("Gore/GripOfChaosRedGore4"), 1f);
            }
        }
        ...
        public override void NPCLoot()
        {
            ...
            else
            {
                ...
                {
                    Item.NewItem((int)npc.position.X, (int)npc.position.Y, npc.width, npc.height, mod.ItemType("Incinerite"), Main.rand.Next(15, 44));
                }
                {
                    Item.NewItem((int)npc.position.X, (int)npc.position.Y, npc.width, npc.height, mod.ItemType("InfernoInsignia"));
                }
            }
        }
        ...
        public override void AI()
        {
            ...
            {
                NPC.NewNPC((int)npc.position.X + 70, (int)npc.position.Y + 70, mod.NPCType("DragonClaw")); //Change name AAAAAAAAAAAAAAAAAAAA
            }
