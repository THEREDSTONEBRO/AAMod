...
namespace AAMod.NPCs.Bosses.Zero
{
    public class VoidStar : ModNPC
    {
        ...
        public override void AI()
        {
            ...
            {
                int ind = NPC.NewNPC((int)(npc.position.X + (double)(npc.width / 2)), (int)npc.position.Y + npc.height / 2, mod.NPCType("VoidStar"), npc.whoAmI, npc.ai[0], npc.ai[1], 0f, 0f, byte.MaxValue);
