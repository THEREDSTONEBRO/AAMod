...
{
    public class handlaser : ModNPC
    {

        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Satan's Laser");
        }
        ...
        public override void AI()
        {
            ...
            {
                int ind = NPC.NewNPC((int)(npc.position.X + (double)(npc.width / 2)), (int)npc.position.Y + npc.height / 2, mod.NPCType("handflame"), npc.whoAmI, 2f, npc.ai[1], 0f, 0f, byte.MaxValue);
