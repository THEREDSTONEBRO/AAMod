...
{
    [AutoloadBossHead]
    public class SAkumaA : ModNPC
	{
        public override string Texture { get { return "AAMod/NPCs/Bosses/Shadow/Akuma/SAkumaA"; } }
		...
		{
			DisplayName.SetDefault("Shadow of Akuma Awakened");
            ...
            if (Main.netMode != 1)
			{
				if (npc.ai[0] == 0)
				{
					...
					for (int i = 0; i < AkumaALength; ++i)
					{
                        ...
                        {
                            latestNPC = NPC.NewNPC((int)npc.Center.X, (int)npc.Center.Y, mod.NPCType("SAkumaABody"), npc.whoAmI, 0, latestNPC);
                        ...
                        {
                            latestNPC = NPC.NewNPC((int)npc.Center.X, (int)npc.Center.Y, mod.NPCType("SAkumaAArms"), npc.whoAmI, 0, latestNPC);
                            Main.npc[(int)latestNPC].realLife = npc.whoAmI;
                            Main.npc[(int)latestNPC].ai[3] = npc.whoAmI;
                            segment += 1;
                        }
                    ...
                    latestNPC = NPC.NewNPC((int)npc.Center.X, (int)npc.Center.Y, mod.NPCType("SAkumaATail"), npc.whoAmI, 0, latestNPC);
					Main.npc[(int)latestNPC].realLife = npc.whoAmI;
					Main.npc[(int)latestNPC].ai[3] = npc.whoAmI;
        ...
        public override bool PreDraw(SpriteBatch spriteBatch, Color drawColor)
        {
            ...
            Texture2D attackAni = mod.GetTexture("NPCs/Bosses/Shadow/Akuma/SAkumaA");
    ...
    public class SAkumaABody : SAkumaA
    {
        public override string Texture { get { return "AAMod/NPCs/Bosses/Shadow/Akuma/SAkumaABody"; } }
    ...
    public class SAkumaATail : SAkumaA
    {
        public override string Texture { get { return "AAMod/NPCs/Bosses/Shadow/Akuma/SAkumaATail"; } }
